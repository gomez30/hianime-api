...
$proxy = 'https://m3proxy.animesobt.xyz/m3u8-proxy?url=';
$episodeSrcs = $data['data'];
$videoUrl = $data['data']['sources'][0]['url'];
$encodedVideoUrl = rawurlencode($videoUrl);
    ...
    <script>
        const playerInstance = jwplayer("player").setup({
            ...
            playlist: [{
                ...
                sources: [{ file: `<?php echo $proxy . $encodedVideoUrl; ?>` }, { file: `<?php echo $videoUrl; ?>` }],
                tracks: [
                <?php
